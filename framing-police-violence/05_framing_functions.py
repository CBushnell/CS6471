...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', type=str, help='path to input file', default='data/prepared/shootings/local_police_killing_articles.csv')
    ...
    if MULTI:
        ...
        for w_i in [0]:
            ...
            frames = F.extract_frames(data_slice)
            frames.to_csv('frames-extracted/local_shooting_frames_%s_%s.csv' % (start_idx, end_idx))