...
def main():
    ...
    parser.add_argument('--output', type=str, help='path to input file', default='data/prepared/shootings/local_shooting_frames_.csv')
    args = parser.parse_args()
    
    data = []
    for fn in glob.glob('frames-extracted/local*.csv'):
